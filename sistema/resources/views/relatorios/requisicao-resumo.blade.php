        ...
        <section class="invoice">
            ...
            <div class="row">
                {{-- <div class="row">
                        <div class="col-sm-1 ">
                            <label>Código</label>
                            <input type="text" name="name" class=" form-control form-control-border"
                                value="{{ $requisicao->id }}" disabled>

                        </div>
                        <div class="col-sm-3">
                            <label>Requisição</label>
                            <input type="text" name="name" class=" form-control form-control-border"
                                value="{{ $requisicao->requisicao_ano }}" disabled>
                        ...
                        <div class="col-sm-4">
                            ...
                            <input disabled type="text" name="name" class=" form-control form-control-border"
                                value="{{ $requisicao->unidades->secretaria->nome }}" disabled>
                        ...
                        <div class="col-sm-4">
                            ...
                            <input disabled type="text" name="name" class=" form-control form-control-border"
                                value="{{ $requisicao->unidades->nome }}">
