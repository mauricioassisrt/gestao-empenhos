                    ...
                    <tr>
                        ...
                        @if ($pessoa->id>1)
                            ...
                            <td>
                                ...
                                @endcan
                                @can('Edit_unidade')
                                    <a href="{{ url('users/visualizar/' . $pessoa->users->id) }}"
                                ...
                                @can('pessoa_redefinir_senha')
                                    ...
                                    <a href="" class="btn btn-primary" data-toggle="modal"
                                       data-target="#modal-redefinir-senha-{{ $pessoa->id }}"
                                       title=" Redefinir senha"><span
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-footer justify-content-between">
                                    ...
                                    <button type="submit" class="btn btn-success float-right" id="resumo"><i
                                            class=" fas fa-pen-alt"></i> Atualizar
                                    </button>
